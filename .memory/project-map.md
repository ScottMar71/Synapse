...
- `packages/contracts/src/lms-api.ts`: Zod/OpenAPI DTO schemas for LMS HTTP payloads (includes `lessonWatchState*` sketches per decision **012**; no HTTP routes yet).
